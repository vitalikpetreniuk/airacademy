!function (t, e) {
    ...
    "use strict";
    var n = [], i = t.document, r = Object.getPrototypeOf, s = n.slice, o = n.concat, a = n.push, l = n.indexOf, u = {},
        c = u.toString, h = u.hasOwnProperty, p = h.toString, d = p.call(Object), f = {}, g = function (t) {
    ...
    function y(t, e, n) {
        ...
        if (s.text = t, n) for (r in v) n[r] && (s[r] = n[r]);
    ...
    x.fn = x.prototype = {
        ...
        for ("boolean" == typeof o && (u = o, o = arguments[a] || {}, a++), "object" == typeof o || g(o) || (o = {}), a === l && (o = this, a--); a < l; a++) if (null != (t = arguments[a])) for (e in t) n = o[e], o !== (i = t[e]) && (u && i && (x.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1, s = n && Array.isArray(n) ? n : []) : s = n && x.isPlainObject(n) ? n : {}, o[e] = x.extend(u, s, i)) : void 0 !== i && (o[e] = i));
        return o
    }, x.extend({
        expando: "jQuery" + ("3.3.1" + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (t) {
            ...
            var n = e || [];
            return null != t && (b(Object(t)) ? x.merge(n, "string" == typeof t ? [t] : t) : a.call(n, t)), n
    ...
    var C = function (t) {
        var e, n, i, r, s, o, a, l, u, c, h, p, d, f, g, m, v, y, w, x = "sizzle" + 1 * new Date, _ = t.document, b = 0,
            C = 0, T = ot(), E = ot(), $ = ot(), D = function (t, e) {
                return t === e && (h = !0), 0
            }, k = {}.hasOwnProperty, S = [], j = S.pop, A = S.push, N = S.push, L = S.slice, q = function (t, e) {
            ...
            O = "\\[" + z + "*(" + P + ")(?:" + z + "*([*^$|!~]?=)" + z + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + P + "))|)" + z + "*\\]",
            M = ":(" + P + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + O + ")*)|.*)\\)|)",
            I = new RegExp(z + "+", "g"), R = new RegExp("^" + z + "+|((?:^|[^\\\\])(?:\\\\.)*)" + z + "+$", "g"),
            W = new RegExp("^" + z + "*," + z + "*"), B = new RegExp("^" + z + "*([>+~]|" + z + ")" + z + "*"),
            F = new RegExp("=" + z + "*([^\\]'\"]*?)" + z + "*\\]", "g"), U = new RegExp(M),
            X = new RegExp("^" + P + "$"), V = {
                ID: new RegExp("^#(" + P + ")"),
                CLASS: new RegExp("^\\.(" + P + ")"),
                TAG: new RegExp("^(" + P + "|[*])"),
            ...
            Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, J = /[+~]/,
            K = new RegExp("\\\\([\\da-f]{1,6}" + z + "?|(" + z + ")|.)", "ig"), tt = function (t, e, n) {
                var i = "0x" + e - 65536;
        ...
        try {
            N.apply(S = L.call(_.childNodes), _.childNodes), S[_.childNodes.length].nodeType
        } catch (t) {
            N = {
        ...
        function st(t, e, i, r) {
            ...
            if (!r && ((e ? e.ownerDocument || e : _) !== d && p(e), e = e || d, g)) {
                ...
                if (n.qsa && !$[t + " "] && (!m || !m.test(t))) {
                    if (1 !== b) y = e, v = t; else if ("object" !== e.nodeName.toLowerCase()) {
                        for ((c = e.getAttribute("id")) ? c = c.replace(et, nt) : e.setAttribute("id", c = x), a = (f = o(t)).length; a--;) f[a] = "#" + c + " " + vt(f[a]);
        ...
        for (e in n = st.support = {}, s = st.isXML = function (t) {
            ...
            return o !== d && 9 === o.nodeType && o.documentElement ? (f = (d = o).documentElement, g = !s(d), _ !== d && (r = d.defaultView) && r.top !== r && (r.addEventListener ? r.addEventListener("unload", it, !1) : r.attachEvent && r.attachEvent("onunload", it)), n.attributes = lt(function (t) {
            ...
            }), m = m.length && new RegExp(m.join("|")), v = v.length && new RegExp(v.join("|")), e = Y.test(f.compareDocumentPosition), w = e || Y.test(f.contains) ? function (t, e) {
                ...
                return i || (1 & (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !n.sortDetached && e.compareDocumentPosition(t) === i ? t === d || t.ownerDocument === _ && w(_, t) ? -1 : e === d || e.ownerDocument === _ && w(_, e) ? 1 : c ? q(c, t) - q(c, e) : 0 : 4 & i ? -1 : 1)
            } : function (t, e) {
                if (t === e) return h = !0, 0;
            ...
            if ((t.ownerDocument || t) !== d && p(t), e = e.replace(F, "='$1']"), n.matchesSelector && g && !$[e + " "] && (!v || !v.test(e)) && (!m || !m.test(e))) try {
                var i = y.call(t, e);
                    ...
                    return 1 === i && 0 === r ? function (t) {
                        ...
                        if (m) {
                            ...
                            if (f = [o ? m.firstChild : m.lastChild], o && y) {
                                for (w = (d = (u = (c = (h = (p = m)[x] || (p[x] = {}))[p.uniqueID] || (h[p.uniqueID] = {}))[t] || [])[0] === b && u[1]) && u[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (w = d = 0) || f.pop();) if (1 === p.nodeType && ++w && p === e) {
                                    c[t] = [b, d, w];
                                    break
                                }
                            } else if (y && (w = d = (u = (c = (h = (p = e)[x] || (p[x] = {}))[p.uniqueID] || (h[p.uniqueID] = {}))[t] || [])[0] === b && u[1]), !1 === w) for (; (p = ++d && p && p[g] || (w = d = 0) || f.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++w || (y && ((c = (h = p[x] || (p[x] = {}))[p.uniqueID] || (h[p.uniqueID] = {}))[t] = [b, w]), p !== e));) ;
            ...
            pseudos: {
                not: at(function (t) {
                    ...
                    return X.test(t || "") || st.error("unsupported lang: " + t), t = t.replace(K, tt).toLowerCase(), function (e) {
                        var n;
                        do {
        ...
        function yt(t, e, n) {
            ...
            return e.first ? function (e, n, r) {
                ...
                } else for (; e = e[i];) if (1 === e.nodeType || o) if (c = (h = e[x] || (e[x] = {}))[e.uniqueID] || (h[e.uniqueID] = {}), r && r === e.nodeName.toLowerCase()) e = e[i] || e; else {
        ...
        function _t(t, e, n, i, r, s) {
            return i && !i[x] && (i = _t(i)), r && !r[x] && (r = _t(r, s)), at(function (s, o, a, l) {
                var u, c, h, p = [], d = [], f = o.length, g = s || function (t, e, n) {
                        for (var i = 0, r = e.length; i < r; i++) st(t, e[i], n);
                        return n
                    }(e || "*", a.nodeType ? [a] : a, []), m = !t || !s && e ? g : xt(g, p, t, a, l),
                    v = n ? r || (s ? t : f || i) ? [] : o : m;
                if (n && n(m, v, a, l), i) for (u = xt(v, d), i(u, [], a, l), c = u.length; c--;) (h = u[c]) && (v[d[c]] = !(m[d[c]] = h));
                if (s) {
                    if (r || t) {
                        if (r) {
        ...
        function bt(t) {
            for (var e, n, r, s = t.length, o = i.relative[t[0].type], a = o || i.relative[" "], l = o ? 1 : 0, c = yt(function (t) {
                ...
                return e = null, r
            }]; l < s; l++) if (n = i.relative[t[l].type]) p = [yt(wt(p), n)]; else {
        ...
        function Ct(t, e) {
            var n = e.length > 0, r = t.length > 0, s = function (s, o, a, l, c) {
                var h, f, m, v = 0, y = "0", w = s && [], x = [], _ = u, C = s || r && i.find.TAG("*", c),
                    T = b += null == _ ? 1 : Math.random() || .1, E = C.length;
                for (c && (u = o === d || o || c); y !== E && null != (h = C[y]); y++) {
                    if (r && h) {
                        for (f = 0, o || h.ownerDocument === d || (p(h), a = !g); m = t[f++];) if (m(h, o || d, a)) {
                            l.push(h);
                            break
                        }
                        c && (b = T)
                ...
                if (v += y, n && y !== v) {
                    ...
                    if (s) {
                        if (v > 0) for (; y--;) w[y] || x[y] || (x[y] = j.call(l));
                        x = xt(x)
                    }
                    N.apply(l, x), c && !s && x.length > 0 && v + e.length > 1 && st.uniqueSort(l)
                }
                return c && (b = T, u = _), w
            };
            return n ? at(s) : s
        ...
        return mt.prototype = i.filters = i.pseudos, i.setFilters = new mt, o = st.tokenize = function (t, e) {
            ...
            if (n = n || [], 1 === d.length) {
                ...
                for (s = V.needsContext.test(t) ? 0 : l.length; s-- && (u = l[s], !i.relative[c = u.type]);) if ((h = i.find[c]) && (r = h(u.matches[0].replace(K, tt), J.test(l[0].type) && gt(e.parentNode) || e))) {
                    if (l.splice(s, 1), !(t = r.length && vt(l))) return N.apply(n, r), n;
                    break
                }
            }
            return (p || a(t, d))(r, e, !g, n, !e || J.test(t) && gt(e.parentNode) || e), n
        }, n.sortStable = x.split("").sort(D).join("") === x, n.detectDuplicates = !!h, p(), n.sortDetached = lt(function (t) {
    ...
    x.filter = function (t, e, n) {
        ...
        find: function (t) {
            ...
            return !!S(this, "string" == typeof t && $.test(t) ? x(t) : t || [], !1).length
        }
    });
    var j, A = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (x.fn.init = function (t, e, n) {
        ...
        if (n = n || j, "string" == typeof t) {
            ...
            if (r[1]) {
                if (e = e instanceof x ? e[0] : e, x.merge(this, x.parseHTML(r[1], e && e.nodeType ? e.ownerDocument || e : i, !0)), k.test(r[1]) && x.isPlainObject(e)) for (r in e) g(this[r]) ? this[r](e[r]) : this.attr(r, e[r]);
                return this
            }
    ...
    x.fn.extend({
        has: function (t) {
            ...
            if (!$.test(t)) for (; i < r; i++) for (n = this[i]; n && n !== e; n = n.parentNode) if (n.nodeType < 11 && (o ? o.index(n) > -1 : 1 === n.nodeType && x.find.matchesSelector(n, t))) {
                s.push(n);
                break
            }
    ...
    x.Callbacks = function (t) {
        t = "string" == typeof t ? function (t) {
            var e = {};
            return x.each(t.match(H) || [], function (t, n) {
                e[n] = !0
            }), e
        }(t) : x.extend({}, t);
            ...
            add: function () {
                return s && (n && !e && (a = s.length - 1, o.push(n)), function e(n) {
                    x.each(n, function (n, i) {
                        g(i) ? t.unique && u.has(i) || s.push(i) : i && i.length && "string" !== w(i) && e(i)
                    })
        ...
        Deferred: function (e) {
                ...
                i = "pending", r = {
                    state: function () {
                            ...
                            return function () {
                                var a = this, l = arguments, u = function () {
                                    ...
                                    if (!(e < s)) {
                                        ...
                                        u = t && ("object" == typeof t || "function" == typeof t) && t.then, g(u) ? r ? u.call(t, o(s, n, z, r), o(s, n, P, r)) : (s++, u.call(t, o(s, n, z, r), o(s, n, P, r), o(s, n, z, n.notifyWith))) : (i !== z && (a = void 0, l = [t]), (r || n.resolveWith)(a, l))
                                    }
                                }, c = r ? u : function () {
                                    try {
                                        u()
                                    } catch (t) {
                                        x.Deferred.exceptionHook && x.Deferred.exceptionHook(t, c.stackTrace), e + 1 >= s && (i !== P && (a = void 0, l = [t]), n.rejectWith(a, l))
                                    }
                                };
                        ...
                        return x.Deferred(function (t) {
                            n[0][3].add(o(0, t, g(r) ? r : z, t.notifyWith)), n[1][3].add(o(0, t, g(e) ? e : z)), n[2][3].add(o(0, t, g(i) ? i : P))
                        }).promise()
                    }, promise: function (t) {
            ...
            var e = arguments.length, n = e, i = Array(n), r = s.call(arguments), o = x.Deferred(), a = function (t) {
                return function (n) {
    ...
    function R() {
        i.removeEventListener("DOMContentLoaded", R), t.removeEventListener("load", R), x.ready()
    }
    ...
    x.fn.ready = function (t) {
        ...
        isReady: !1, readyWait: 1, ready: function (t) {
            (!0 === t ? --x.readyWait : x.isReady) || (x.isReady = !0, !0 !== t && --x.readyWait > 0 || I.resolveWith(i, [x]))
        }
    }), x.ready.then = I.then, "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? t.setTimeout(x.ready) : (i.addEventListener("DOMContentLoaded", R), t.addEventListener("load", R));
    var W = function (t, e, n, i, r, s, o) {
        var a = 0, l = t.length, u = null == n;
        if ("object" === w(n)) for (a in r = !0, n) W(t, e, a, n[a], !0, s, o); else if (void 0 !== i && (r = !0, g(i) || (o = !0), u && (o ? (e.call(t, i), e = null) : (u = e, e = function (t, e, n) {
            return u.call(x(t), n)
    ...
    x.extend({
        ...
        queue: function (t, e, n) {
            ...
            e = e || "fx";
            var n = x.queue(t, e), i = n.length, r = n.shift(), s = x._queueHooks(t, e);
    ...
    function st(t, e, n, i) {
        var r, s, o = 20, a = i ? function () {
                ...
                return x.css(t, e, "")
            }, l = a(), u = n && n[3] || (x.cssNumber[e] ? "" : "px"),
            c = (x.cssNumber[e] || "px" !== u && +l) && et.exec(x.css(t, e));
        if (c && c[3] !== u) {
            for (l /= 2, u = u || c[3], c = +l || 1; o--;) x.style(t, e, c + u), (1 - s) * (1 - (s = a() / l || .5)) <= 0 && (o = 0), c /= s;
    ...
    function at(t) {
        var e, n = t.ownerDocument, i = t.nodeName, r = ot[i];
    ...
    function mt(t, e, n, i, r) {
        for (var s, o, a, l, u, c, h = e.createDocumentFragment(), p = [], d = 0, f = t.length; d < f; d++) if ((s = t[d]) || 0 === s) if ("object" === w(s)) x.merge(p, s.nodeType ? [s] : s); else if (gt.test(s)) {
            for (o = o || h.appendChild(e.createElement("div")), a = (ct.exec(s) || ["", ""])[1].toLowerCase(), l = pt[a] || pt._default, o.innerHTML = l[1] + x.htmlPrefilter(s) + l[2], c = l[0]; c--;) o = o.lastChild;
            x.merge(p, o.childNodes), (o = h.firstChild).textContent = ""
        } else p.push(e.createTextNode(s));
        for (h.textContent = "", d = 0; s = p[d++];) if (i && x.inArray(s, i) > -1) r && r.push(s); else if (u = x.contains(s.ownerDocument, s), o = dt(h.appendChild(s), "script"), u && ft(o), n) for (c = 0; s = o[c++];) ht.test(s.type || "") && n.push(s);
        return h
    }
    ...
    var vt = i.documentElement, yt = /^key/, wt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
        xt = /^([^.]*)(?:\.(.+)|)/;
    ...
    x.event = {
        global: {}, add: function (t, e, n, i, r) {
            ...
            if (m) for (n.handler && (n = (s = n).handler, r = s.selector), r && x.find.matchesSelector(vt, r), n.guid || (n.guid = x.guid++), (l = m.events) || (l = m.events = {}), (o = m.handle) || (o = m.handle = function (e) {
                return void 0 !== x && x.event.triggered !== e.type ? x.event.dispatch.apply(t, arguments) : void 0
            }), u = (e = (e || "").match(H) || [""]).length; u--;) d = g = (a = xt.exec(e[u]) || [])[1], f = (a[2] || "").split(".").sort(), d && (h = x.event.special[d] || {}, d = (r ? h.delegateType : h.bindType) || d, h = x.event.special[d] || {}, c = x.extend({
                type: d,
                origType: g,
                data: i,
                handler: n,
                ...
                namespace: f.join(".")
            }, s), (p = l[d]) || ((p = l[d] = []).delegateCount = 0, h.setup && !1 !== h.setup.call(t, i, f, o) || t.addEventListener && t.addEventListener(d, o)), h.add && (h.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, c) : p.push(c), x.event.global[d] = !0)
        }, remove: function (t, e, n, i, r) {
            var s, o, a, l, u, c, h, p, d, f, g, m = G.hasData(t) && G.get(t);
            if (m && (l = m.events)) {
                for (u = (e = (e || "").match(H) || [""]).length; u--;) if (d = g = (a = xt.exec(e[u]) || [])[1], f = (a[2] || "").split(".").sort(), d) {
                    for (h = x.event.special[d] || {}, p = l[d = (i ? h.delegateType : h.bindType) || d] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = s = p.length; s--;) c = p[s], !r && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (p.splice(s, 1), c.selector && p.delegateCount--, h.remove && h.remove.call(t, c));
            ...
            var e, n, i, r, s, o, a = x.event.fix(t), l = new Array(arguments.length),
                u = (G.get(this, "events") || {})[a.type] || [], c = x.event.special[a.type] || {};
            ...
            if (l && u.nodeType && !("click" === t.type && t.button >= 1)) for (; u !== this; u = u.parentNode || this) if (1 === u.nodeType && ("click" !== t.type || !0 !== u.disabled)) {
                for (s = [], o = {}, n = 0; n < l; n++) void 0 === o[r = (i = e[n]).selector + " "] && (o[r] = i.needsContext ? x(r, this).index(u) > -1 : x.find(r, this, null, [u]).length), o[r] && s.push(i);
    ...
    var Et = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
        $t = /<script|<style|<link/i, Dt = /checked\s*(?:[^=]|=\s*.checked.)/i,
        kt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ...
    function Nt(t, e) {
        var n, i, r, s, o, a, l, u;
        if (1 === e.nodeType) {
            if (G.hasData(t) && (s = G.access(t), o = G.set(e, s), u = s.events)) for (r in delete o.handle, o.events = {}, u) for (n = 0, i = u[r].length; n < i; n++) x.event.add(e, r, u[r][n]);
            Y.hasData(t) && (a = Y.access(t), l = x.extend({}, a), Y.set(e, l))
        }
    }
    ...
    function qt(t, e, n, i) {
        e = o.apply([], e);
        var r, s, a, l, u, c, h = 0, p = t.length, d = p - 1, m = e[0], v = g(m);
        if (v || p > 1 && "string" == typeof m && !f.checkClone && Dt.test(m)) return t.each(function (r) {
            var s = t.eq(r);
            v && (e[0] = m.call(this, r, s.html())), qt(s, e, n, i)
        });
        if (p && (s = (r = mt(e, t[0].ownerDocument, !1, t, i)).firstChild, 1 === r.childNodes.length && (r = s), s || i)) {
            for (l = (a = x.map(dt(r, "script"), jt)).length; h < p; h++) u = r, h !== d && (u = x.clone(u, !0, !0), l && x.merge(a, dt(u, "script"))), n.call(t[h], u, h);
            if (l) for (c = a[a.length - 1].ownerDocument, x.map(a, At), h = 0; h < l; h++) u = a[h], ht.test(u.type || "") && !G.access(u, "globalEval") && x.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? x._evalUrl && x._evalUrl(u.src) : y(u.textContent.replace(kt, ""), c, u))
        }
        return t
    }
    ...
    x.extend({
        htmlPrefilter: function (t) {
            ...
            var i, r, s, o, a = t.cloneNode(!0), l = x.contains(t.ownerDocument, t);
            if (!(f.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || x.isXMLDoc(t))) for (o = dt(a), i = 0, r = (s = dt(t)).length; i < r; i++) Lt(s[i], o[i]);
            if (e) if (n) for (s = s || dt(t), o = o || dt(a), i = 0, r = s.length; i < r; i++) Nt(s[i], o[i]); else Nt(t, a);
            return (o = dt(a, "script")).length > 0 && ft(o, !l && dt(t, "script")), a
        }, cleanData: function (t) {
            for (var e, n, i, r = x.event.special, s = 0; void 0 !== (n = t[s]); s++) if (V(n)) {
                if (e = n[G.expando]) {
        ...
        detach: function (t) {
            ...
            return W(this, function (t) {
                ...
                if ("string" == typeof t && !$t.test(t) && !pt[(ct.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = x.htmlPrefilter(t);
                    try {
    ...
    var zt = new RegExp("^(" + tt + ")(?!px)[a-z%]+$", "i"), Pt = function (e) {
    ...
    function Mt(t, e, n) {
        ...
        return (n = n || Pt(t)) && ("" !== (o = n.getPropertyValue(e) || n[e]) || x.contains(t.ownerDocument, t) || (o = x.style(t, e)), !f.pixelBoxStyles() && zt.test(o) && Ot.test(e) && (i = a.width, r = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = o, o = n.width, a.width = i, a.minWidth = r, a.maxWidth = s)), void 0 !== o ? o + "" : o
    }
    ...
    !function () {
        ...
        var r, s, o, a, l, u = i.createElement("div"), c = i.createElement("div");
    ...
    var Rt = /^(none|table(?!-c[ea]).+)/, Wt = /^--/,
        Bt = {position: "absolute", visibility: "hidden", display: "block"},
        Ft = {letterSpacing: "0", fontWeight: "400"}, Ut = ["Webkit", "Moz", "ms"], Xt = i.createElement("div").style;
    ...
    function Yt(t, e, n) {
        var i = Pt(t), r = Mt(t, e, i), s = "border-box" === x.css(t, "boxSizing", !1, i), o = s;
        if (zt.test(r)) {
            if (!n) return r;
            r = "auto"
        }
        return o = o && (f.boxSizingReliable() || r === t.style[e]), ("auto" === r || !parseFloat(r) && "inline" === x.css(t, "display", !1, i)) && (r = t["offset" + e[0].toUpperCase() + e.slice(1)], o = !0), (r = parseFloat(r) || 0) + Gt(t, e, n || (s ? "border" : "content"), o, i, r) + "px"
    }
    ...
    x.extend({
        ...
        style: function (t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var r, s, o, a = X(e), l = Wt.test(e), u = t.style;
                if (l || (e = Vt(a)), o = x.cssHooks[e] || x.cssHooks[a], void 0 === n) return o && "get" in o && void 0 !== (r = o.get(t, !1, i)) ? r : u[e];
                "string" == (s = typeof n) && (r = et.exec(n)) && r[1] && (n = st(t, e, r), s = "number"), null != n && n == n && ("number" === s && (n += r && r[3] || (x.cssNumber[a] ? "" : "px")), f.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (u[e] = "inherit"), o && "set" in o && void 0 === (n = o.set(t, n, i)) || (l ? u.setProperty(e, n) : u[e] = n))
            }
        },
        ...
        x.cssHooks[e] = {
            get: function (t, n, i) {
                if (n) return !Rt.test(x.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Yt(t, e, i) : rt(t, Bt, function () {
                    return Yt(t, e, i)
                })
            }, set: function (t, n, i) {
                var r, s = Pt(t), o = "border-box" === x.css(t, "boxSizing", !1, s), a = i && Gt(t, e, i, o, s);
                return o && f.scrollboxSize() === s.position && (a -= Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - parseFloat(s[e]) - Gt(t, e, "border", !1, s) - .5)), a && (r = et.exec(n)) && "px" !== (r[3] || "px") && (t.style[e] = n, n = x.css(t, e)), Qt(0, n, a)
            }
        }
    }), x.cssHooks.marginLeft = It(f.reliableMarginLeft, function (t, e) {
        if (e) return (parseFloat(Mt(t, "marginLeft")) || t.getBoundingClientRect().left - rt(t, {marginLeft: 0}, function () {
    ...
    }), x.Tween = Zt, Zt.prototype = {
        constructor: Zt, init: function (t, e, n, i, r, s) {
            ...
            return this.options.duration ? this.pos = e = x.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : Zt.propHooks._default.set(this), this
        }
    ...
    }, x.fx = Zt.prototype.init, x.fx.step = {};
    var Jt, Kt, te = /^(?:toggle|show|hide)$/, ee = /queueHooks$/;

    function ne() {
        Kt && (!1 === i.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(ne) : t.setTimeout(ne, x.fx.interval), x.fx.tick())
    }
    ...
    function se(t, e, n) {
        for (var i, r = (oe.tweeners[e] || []).concat(oe.tweeners["*"]), s = 0, o = r.length; s < o; s++) if (i = r[s].call(n, e, t)) return i
    }

    function oe(t, e, n) {
        var i, r, s = 0, o = oe.prefilters.length, a = x.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (r) return !1;
        ...
        for (function (t, e) {
            var n, i, r, s, o;
            for (n in t) if (r = e[i = X(n)], s = t[n], Array.isArray(s) && (r = s[1], s = t[n] = s[0]), n !== i && (t[i] = s, delete t[n]), (o = x.cssHooks[i]) && "expand" in o) for (n in s = o.expand(s), delete t[i], s) n in t || (t[n] = s[n], e[n] = r); else e[i] = r
        }(c, u.opts.specialEasing); s < o; s++) if (i = oe.prefilters[s].call(u, t, c, u.opts)) return g(i.stop) && (x._queueHooks(u.elem, u.opts.queue).stop = i.stop.bind(i)), i;
        return x.map(c, se, u), g(u.opts.start) && u.opts.start.call(t, u), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always), x.fx.timer(x.extend(l, {
            elem: t,
            anim: u,
            queue: u.opts.queue
        })), u
    ...
    x.Animation = x.extend(oe, {
        tweeners: {
            ...
            var i, r, s, o, a, l, u, c, h = "width" in e || "height" in e, p = this, d = {}, f = t.style,
                g = t.nodeType && it(t), m = G.get(t, "fxshow");
            ...
            if ((l = !x.isEmptyObject(e)) || !x.isEmptyObject(d)) for (i in h && 1 === t.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (u = m && m.display) && (u = G.get(t, "display")), "none" === (c = x.css(t, "display")) && (u ? c = u : (lt([t], !0), u = t.style.display || u, c = x.css(t, "display"), lt([t]))), ("inline" === c || "inline-block" === c && null != u) && "none" === x.css(t, "float") && (l || (p.done(function () {
                f.display = u
            }), null == u && (c = f.display, u = "none" === c ? "" : c)), f.display = "inline-block")), n.overflow && (f.overflow = "hidden", p.always(function () {
                f.overflow = n.overflow[0], f.overflowX = n.overflow[1], f.overflowY = n.overflow[2]
            })), l = !1, d) l || (m ? "hidden" in m && (g = m.hidden) : m = G.access(t, "fxshow", {display: u}), s && (m.hidden = !g), g && lt([t], !0), p.done(function () {
                for (i in g || lt([t]), G.remove(t, "fxshow"), d) x.style(t, i, d[i])
        ...
        fadeTo: function (t, e, n, i) {
            ...
            var r = x.isEmptyObject(t), s = x.speed(e, n, i), o = function () {
            ...
            return "string" != typeof t && (n = e, e = t, t = void 0), e && !1 !== t && this.queue(t || "fx", []), this.each(function () {
                var e = !0, r = null != t && t + "queueHooks", s = x.timers, o = G.get(this);
                if (r) o[r] && o[r].stop && i(o[r]); else for (r in o) o[r] && o[r].stop && ee.test(r) && i(o[r]);
                for (r = s.length; r--;) s[r].elem !== this || null != t && s[r].queue !== t || (s[r].anim.stop(n), e = !1, s.splice(r, 1));
                !e && n || x.dequeue(this, t)
            })
        }, finish: function (t) {
            return !1 !== t && (t = t || "fx"), this.each(function () {
                var e, n = G.get(this), i = n[t + "queue"], r = n[t + "queueHooks"], s = x.timers, o = i ? i.length : 0;
        ...
        Kt = null
    }, x.fx.speeds = {slow: 600, fast: 200, _default: 400}, x.fn.delay = function (e, n) {
    ...
    x.fn.extend({
        ...
        addClass: function (t) {
            ...
            if ((e = de(t)).length) for (; n = this[l++];) if (r = pe(n), i = 1 === n.nodeType && " " + he(r) + " ") {
            ...
            return "boolean" == typeof e && i ? e ? this.addClass(t) : this.removeClass(t) : g(t) ? this.each(function (n) {
                ...
                var e, r, s, o;
                if (i) for (r = 0, s = x(this), o = de(t); e = o[r++];) s.hasClass(e) ? s.removeClass(e) : s.addClass(e); else void 0 !== t && "boolean" !== n || ((e = pe(this)) && G.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : G.get(this, "__className__") || ""))
            })
        }, hasClass: function (t) {
            var e, n, i = 0;
    ...
    x.extend(x.event, {
        trigger: function (e, n, r, s) {
            var o, a, l, u, c, p, d, f, v = [r || i], y = h.call(e, "type") ? e.type : e,
            ...
            if (a = f = l = r = r || i, 3 !== r.nodeType && 8 !== r.nodeType && !ge.test(y + x.event.triggered) && (y.indexOf(".") > -1 && (y = (w = y.split(".")).shift(), w.sort()), c = y.indexOf(":") < 0 && "on" + y, (e = e[x.expando] ? e : new x.Event(y, "object" == typeof e && e)).isTrigger = s ? 2 : 3, e.namespace = w.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + w.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), n = null == n ? [e] : x.makeArray(n, [e]), d = x.event.special[y] || {}, s || !d.trigger || !1 !== d.trigger.apply(r, n))) {
                if (!s && !d.noBubble && !m(r)) {
                    for (u = d.delegateType || y, ge.test(u + y) || (a = a.parentNode); a; a = a.parentNode) v.push(a), l = a;
                    l === (r.ownerDocument || i) && v.push(l.defaultView || l.parentWindow || t)
                }
                for (o = 0; (a = v[o++]) && !e.isPropagationStopped();) f = a, e.type = o > 1 ? u : d.bindType || y, (p = (G.get(a, "events") || {})[e.type] && G.get(a, "handle")) && p.apply(a, n), (p = c && a[c]) && p.apply && V(a) && (e.result = p.apply(a, n), !1 === e.result && e.preventDefault());
                return e.type = y, s || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(v.pop(), n) || !V(r) || c && g(r[y]) && !m(r) && ((l = r[c]) && (r[c] = null), x.event.triggered = y, e.isPropagationStopped() && f.addEventListener(y, me), r[y](), e.isPropagationStopped() && f.removeEventListener(y, me), x.event.triggered = void 0, l && (r[c] = l)), e.result
            }
    ...
    }), f.focusin || x.each({focus: "focusin", blur: "focusout"}, function (t, e) {
        var n = function (t) {
    ...
    function Te(t, e, n, i) {
        ...
        }); else if (n || "object" !== w(e)) i(t, e); else for (r in e) Te(t + "[" + r + "]", e[r], n, i)
    }
    ...
    x.param = function (t, e) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var t = this.type;
                return this.name && !x(this).is(":disabled") && Ce.test(this.nodeName) && !be.test(t) && (this.checked || !ut.test(t))
            }).map(function (t, e) {
                var n = x(this).val();
    ...
    var Ee = /%20/g, $e = /#.*$/, De = /([?&])_=[^&]*/, ke = /^(.*?):[ \t]*([^\r\n]*)$/gm, Se = /^(?:GET|HEAD)$/,
        je = /^\/\//, Ae = {}, Ne = {}, Le = "*/".concat("*"), qe = i.createElement("a");

    function He(t) {
        return function (e, n) {
            "string" != typeof e && (n = e, e = "*");
            var i, r = 0, s = e.toLowerCase().match(H) || [];
            if (g(n)) for (; i = s[r++];) "+" === i[0] ? (i = i.slice(1) || "*", (t[i] = t[i] || []).unshift(n)) : (t[i] = t[i] || []).push(n)
        }
    }
    ...
    qe.href = ve.href, x.extend({
        ...
        ajax: function (e, n) {
            ...
            var r, s, o, a, l, u, c, h, p, d, f = x.ajaxSetup({}, n), g = f.context || f,
                m = f.context && (g.nodeType || g.jquery) ? x(g) : x.event, v = x.Deferred(),
                y = x.Callbacks("once memory"), w = f.statusCode || {}, _ = {}, b = {}, C = "canceled", T = {
                    readyState: 0, getResponseHeader: function (t) {
                        var e;
                        if (c) {
                            if (!a) for (a = {}; e = ke.exec(o);) a[e[1].toLowerCase()] = e[2];
                            e = a[t.toLowerCase()]
                        }
                        ...
                        var e;
                        if (t) if (c) T.always(t[T.status]); else for (e in t) w[e] = [w[e], t[e]];
                        return this
                    }, abort: function (t) {
                        var e = t || C;
            ...
            if (v.promise(T), f.url = ((e || f.url || ve.href) + "").replace(je, ve.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(H) || [""], null == f.crossDomain) {
                u = i.createElement("a");
                try {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = x.param(f.data, f.traditional)), ze(Ae, f, n, T), c) return T;
            for (p in (h = x.event && f.global) && 0 == x.active++ && x.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Se.test(f.type), s = f.url.replace($e, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Ee, "+")) : (d = f.url.slice(s.length), f.data && (f.processData || "string" == typeof f.data) && (s += (we.test(s) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (s = s.replace(De, "$1"), d = (we.test(s) ? "&" : "?") + "_=" + ye++ + d), f.url = s + d), f.ifModified && (x.lastModified[s] && T.setRequestHeader("If-Modified-Since", x.lastModified[s]), x.etag[s] && T.setRequestHeader("If-None-Match", x.etag[s])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && T.setRequestHeader("Content-Type", f.contentType), T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Le + "; q=0.01" : "") : f.accepts["*"]), f.headers) T.setRequestHeader(p, f.headers[p]);
            if (f.beforeSend && (!1 === f.beforeSend.call(g, T, f) || c)) return T.abort();
            if (C = "abort", y.add(f.complete), T.done(f.success), T.fail(f.error), r = ze(Ne, f, n, T)) {
    ...
    var Oe = {0: 200, 1223: 204}, Me = x.ajaxSettings.xhr();
    f.cors = !!Me && "withCredentials" in Me, f.ajax = Me = !!Me, x.ajaxTransport(function (e) {
        ...
        if (f.cors || Me && !e.crossDomain) return {
            send: function (r, s) {
                ...
                n = function (t) {
                    return function () {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? s(0, "error") : s(a.status, a.statusText) : s(Oe[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                    }
    ...
    x.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = g(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Re, "$1" + r) : !1 !== e.jsonp && (e.url += (we.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
            return o || x.error(r + " was not called"), o[0]
        }, e.dataTypes[0] = "json", s = t[r], t[r] = function () {
            o = arguments
        }, i.always(function () {
            void 0 === s ? x(t).removeProp(r) : t[r] = s, e[r] && (e.jsonpCallback = n.jsonpCallback, Ie.push(r)), o && g(s) && s(o[0]), o = s = void 0
        }), "script"
    }), f.createHTMLDocument = function () {
        var t = i.implementation.createHTMLDocument("").body;
        return t.innerHTML = "<form></form><form></form>", 2 === t.childNodes.length
    }(), x.parseHTML = function (t, e, n) {
        return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (f.createHTMLDocument ? ((r = (e = i.implementation.createHTMLDocument("")).createElement("base")).href = i.location.href, e.head.appendChild(r)) : e = i), o = !n && [], (s = k.exec(t)) ? [e.createElement(s[1])] : (s = mt([t], e, o), o && o.length && x(o).remove(), x.merge([], s.childNodes)));
        var r, s, o
        ...
        setOffset: function (t, e, n) {
            var i, r, s, o, a, l, u = x.css(t, "position"), c = x(t), h = {};
            "static" === u && (t.style.position = "relative"), a = c.offset(), s = x.css(t, "top"), l = x.css(t, "left"), ("absolute" === u || "fixed" === u) && (s + l).indexOf("auto") > -1 ? (o = (i = c.position()).top, r = i.left) : (o = parseFloat(s) || 0, r = parseFloat(l) || 0), g(e) && (e = e.call(t, n, x.extend({}, a))), null != e.top && (h.top = e.top - a.top + o), null != e.left && (h.left = e.left - a.left + r), "using" in e ? e.using.call(t, h) : c.css(h)
        }
    }, x.fn.extend({
        offset: function (t) {
        ...
        x.cssHooks[e] = It(f.pixelPosition, function (t, n) {
            if (n) return n = Mt(t, e), zt.test(n) ? x(t).position()[e] + "px" : n
        })
    ...
    }, x.isArray = Array.isArray, x.parseJSON = JSON.parse, x.nodeName = D, x.isFunction = g, x.isWindow = m, x.camelCase = X, x.type = w, x.now = Date.now, x.isNumeric = function (t) {
        var e = x.type(t);
        return ("number" === e || "string" === e) && !isNaN(t - parseFloat(t))
    }, "function" == typeof define && define.amd && define("jquery", [], function () {
        return x
    });
    var We = t.jQuery, Be = t.$;
    ...
    r.Defaults = {video: !1, videoHeight: !1, videoWidth: !1}, r.prototype.fetch = function (t, e) {
        ...
        var i, r, s = n.width && n.height ? "width:" + n.width + "px;height:" + n.height + "px;" : "",
            o = e.find("img"), a = "src", l = "", u = this._core.settings, c = function (n) {
                i = u.lazyLoad ? t("<div/>", {class: "owl-video-tn " + l, srcType: n}) : t("<div/>", {
                    class: "owl-video-tn",
    ...
    r.Defaults = {
        ...
        if ("page" !== s.slideBy && (s.slideBy = Math.min(s.slideBy, s.items)), s.dots || "page" == s.slideBy) for (this._pages = [], t = n, e = 0; t < i; t++) {
            if (e >= o || 0 === e) {
    ...
    var r = t("<support>").get(0).style, s = "Webkit Moz O ms".split(" "), o = {
        transition: {
            end: {
    ...
    function a(e, n) {
        var o = !1, a = e.charAt(0).toUpperCase() + e.slice(1);
    ...
    var t = $("header#air-header"), e = $("#air-m-menu");
    t.find(".menu-toggle").on("click", function () {
        e.fadeIn("fast")
    }), e.find(".menu-close").on("click", function () {
        e.fadeOut("fast")
    }), $(".format-line").on("click", function () {
        $(".format.active .format-text").slideUp(), $(".format ").removeClass("active"), $(this).parent().addClass("active"), $(this).siblings(".format-text").slideDown()
    }), $(".studies").find(".study-heading").on("click", function () {
        $(this).parent().toggleClass("active"), $(this).siblings(".study-content").slideToggle()
    }), $(".studies").find(".study:first-child .study-heading").trigger("click"), console.log("yes"), $(".experts").owlCarousel({
        dots: !1,
        responsive: {
            0: {margin: 50, items: 1},
            768: {margin: 60, items: 2},
            1024: {margin: 70, items: 2},
            1280: {margin: 70, items: 3},
            1600: {margin: 70, items: 4}
        }
        ...
        center: !0,
        navSpeed: 1e3,
        responsive: {0: {margin: 0, items: 1}, 1024: {margin: 200, items: 2}}
    }), $("button.air-enroll").on("click", function () {
        $("body").addClass("signup-popup-show")
    }), $("#enroll-popup").find(".popup-close").on("click", function () {
        $("body").removeClass("enroll-popup-show")
    }), $("#signup-popup").find(".popup-close").on("click", function () {
        $("body").removeClass("signup-popup-show")
    }), $(window).width() < 768 && $(".packages-inner").owlCarousel({
        items: 1,
        margin: 20,
        center: !0,
        nav: !0,
        ...
        var n = document.getElementById("countdown"), i = n.querySelector(".days"), r = n.querySelector(".hours"),
            s = n.querySelector(".minutes"), o = n.querySelector(".seconds");

        function a() {
            var t = function (t) {
                var e = Date.parse(t) - Date.parse(new Date), n = Math.floor(e / 1e3 % 60),
                    i = Math.floor(e / 1e3 / 60 % 60), r = Math.floor(e / 36e5 % 24);
                return {total: e, days: Math.floor(e / 864e5), hours: r, minutes: i, seconds: n}
            }(e);
            i.innerHTML = t.days, r.innerHTML = ("0" + t.hours).slice(-2), s.innerHTML = ("0" + t.minutes).slice(-2), o.innerHTML = ("0" + t.seconds).slice(-2), t.total <= 0 && clearInterval(l)
        }

        a();
        var l = setInterval(a, 1e3)
    }(0, "March 01 2020 12:27:30 GMT+0300"), setTimeout(function () {
        sessionStorage.getItem("popup") || ($("body").addClass("enroll-popup-show"), sessionStorage.setItem("popup", "true"))
    }, 2e4), $(window).on("load resize scroll", function () {
        var t = $(window).height();
        $(".anchor").each(function () {
            if ($(window).scrollTop() + (t - 200) >= $(this).offset().top) {
                var e = $(this).attr("id");
                $(".menu li").removeClass("active"), $('.menu li a[href="#' + e + '"]').parent().addClass("active")
            } else $(this).hasClass("results") && $(window).scrollTop() + (t - 200) < $(this).offset().top && $(".menu li").removeClass("active")
        })
    }), $(".menu a").on("click", function () {
        $("header#air-header #air-m-menu .menu-close").trigger("click");
        var t = $(this).attr("href"), e = $(t);
        return $("html,body").animate({scrollTop: e.offset().top - 70}, "slow"), !1
    }), $(document).mouseup(function (t) {
        var e = $(".ap-content");
        e.is(t.target) || 0 !== e.has(t.target).length || ($("body").removeClass("enroll-popup-show"), $("body").removeClass("signup-popup-show"))
    })
});
